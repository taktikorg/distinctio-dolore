# @taktikorg/distinctio-dolore

[![npm version](https://badge.fury.io/js/@taktikorg/distinctio-dolore.svg)](https://badge.fury.io/js/@taktikorg/distinctio-dolore)
[![downloads count](https://img.shields.io/npm/dt/@taktikorg/distinctio-dolore.svg)](https://www.npmjs.com/package/@taktikorg/distinctio-dolore)
[![github-ci](https://github.com/taktikorg/distinctio-dolore/actions/workflows/testing.yml/badge.svg)](https://github.com/taktikorg/distinctio-dolore/actions/workflows/testing.yml)
...
Next, install `@taktikorg/distinctio-dolore`:

```bash
npm install -D @taktikorg/distinctio-dolore
```
